...
import com.dashboard.gmelan.entity.News;
...
public class NewsService {
     ...
     * @see News <p>News DataStructure class</p>
     */

    @Cacheable("newsList")
    public List<News> getGoogleNews() {
        // TODO
        ...
        try {
            ...
            for (SyndEntry entry : feed.getEntries()) {
                ...
                article.setPublishedAt(new Timestamp(entry.getPublishedDate().getTime()));


                article.setFetchedAt(new Timestamp(System.currentTimeMillis()));
                article.setCategory("기본 카테고리");
                article.setReporter(entry.getAuthor());
