...
//                return -1 * noticeEntity1.getPublished_at().compareTo(noticeEntity2.getPublished_at());
//            }
//        });
//
...
//                    noticeEntity.setPublished_at(Timestamp.from(date.toInstant()));
...
//                    noticeEntity.setPublished_at(Timestamp.from(date.toInstant()));
//                    noticeEntity.setFetched_at(Timestamp.from(date.toInstant()));
